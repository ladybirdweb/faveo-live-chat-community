...
<div class="container-fluid col-lg-12" >
    ...
    <div class="row">
        <div class="container col-lg-12">
            <h3 class="text-center mt-4"style="color:skyblue;">{{__('english.FAVEO_CHAT')}}</h3>
        </div>
        <div class="container col-lg-12">
            <h3 class="text-center mt-3">{{__('english.Great_to_see_you')}}</h3>
        </div>
                ...
                <main class="form-signin text-center" style="padding-top:80px;padding-right:55px;padding-left:55px;">
                    <form method="POST" action="checklogin">
                        ...
                        <div class="form-floating">
                            ...
                            <label for="floatingInput">{{__('english.Email')}}</label>
                        </div>
                        <div class="form-floating mt-3">
                            <input type="password" class="form-control" id="floatingPassword" name="password" placeholder="Password" >
                            <label for="floatingPassword">{{__('english.Password')}}</label>
                        </div>
                        <button class="w-100 btn btn-lg btn-primary mt-3 mb-3" type="submit">{{__('english.Login')}}</button>
                            <a class="btn btn-primary w-100 mb-3 btn-lg" href="forgetpassword" role="button">{{__('english.Forget_Password')}}</a>
                    </form>
                </main>
            </div>
        </div>
