    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <!-- open a form -->
                <form action="{{URL::route('/operators/add')}}" method="post" class="faveo_agent_add">
                    <input type="hidden" name="_token" value="{{ Session::token() }}">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Create an Agent</h3>	
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <!-- username -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-1 form-group ">
                                    ...
                                    <input class="form-control country_code" value="91" title="Enter your country&#039;s phone code" name="country_code" type="text" id="country_code">
                                </div>
                                <!-- mobile -->
                                <div class="col-xs-3 form-group ">
                                    <label for="mobile">Mobile Number</label>
                                    <input class="form-control mobile" name="mobile" type="text" id="mobile">
                                    <div class="mobile_error"></div>
                                </div>
                                <!-- password -->
                                <div class="col-xs-4 form-group ">
                                    <label for="password">Password</label>
                                    <input class="form-control" name="password" type="text" value="{{$password}}" readonly="">            
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="">
                                <textarea class="form-control agent_sign" id="agent_sign" name="agent_sign" cols="30" rows="5"></textarea>
                            </div>
                            <div>
