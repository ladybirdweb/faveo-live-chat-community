...
<div class="container-fluid col-lg-12" >
    ...
    <div class="row">
        <div class="container col-lg-12">
            <h3 class="text-center mt-3">{{__('english.Enter_OTP')}}</h3>
        </div>
                ...
                <main class="form-signin text-center" style="padding-top:80px;padding-right:55px;padding-left:55px;">
                    ...
                    <form method="POST" action="checkotp">
                        ...
                        <div class="form-floating mt-3">
                            <input type="text" class="form-control" id="floatingPassword" name="otp" placeholder="OTP" >
                            <label for="floatingPassword">{{__('english.OTP')}}</label>
                        </div>
