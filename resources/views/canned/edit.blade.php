  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <form action="{{URL::route('/canned-message/edit')}}" method="post" class="faveo_canned_edit">
          <input type="hidden" name="_token" value="{{ Session::token() }}">
          <input type="hidden" name="id" value="{{ $canned->id }}">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-xs-6 form-group ">
                  ...
                  <input class="form-control title" name="title" type="text" id="title" value="{{ $canned->title }}">
                </div>
                <!-- firstname -->
                <div class="col-xs-12 form-group ">
                  <label for="message">Message</label><span class="text-red"> *</span>
                  <textarea class="form-control message" name="message" cols="50" rows="10" id="message">{{ $canned->message }}</textarea>
                </div>
              </div>
            </div>
