...
Route::get('/', ['as' => '/', 'uses' => 'Chat\HomeController@getIndex']);
Route::get('/admin', ['as' => '/admin', 'uses' => 'Chat\HomeController@getAdmin']);
Route::get('/agent-profile', ['as' => '/agent-profile', 'uses' => 'Chat\HomeController@getAgentProfile']);
Route::get('/message/{id}', ['as' => '/message/{id}', 'uses' => 'Chat\HomeController@getAgentProfile']);
Route::get('/message/history/{id}', ['as' => '/message/history/{id}', 'uses' => 'Chat\HomeController@getAgentHistory']);
Route::get('/message/pdf/{id}', ['as' => '/message/pdf/{id}', 'uses' => 'Chat\HomeController@pdf']);
Route::get('/profile', ['as' => '/profile', 'uses' => 'Chat\HomeController@getProfile']);
Route::get('/profile-edit', ['as' => '/profile-edit', 'uses' => 'Chat\HomeController@getProfileEdit']);
Route::get('/setting', ['as' => '/setting', 'uses' => 'Chat\HomeController@getSetting']);
/* Agent */ 
Route::get('/operators', ['as' => '/operators', 'uses' => 'Chat\HomeController@getOperators']);
Route::get('/operators/add', ['as' => '/operators/add', 'uses' => 'Chat\HomeController@getOperatorsAdd']);
Route::post('/operators/add', ['as' => '/operators/add', 'uses' => 'Chat\OperatorsController@doAdd']);
Route::get('/operators/edit/{id}', ['as' => '/operators/edit/{id}', 'uses' => 'Chat\HomeController@getOperatorsEdit']);
Route::post('/operators/edit', ['as' => '/operators/edit', 'uses' => 'Chat\OperatorsController@doEdit']);
/* End Agent */ 
Route::get('/widget-theme', ['as' => '/widget-theme', 'uses' => 'Chat\HomeController@getWidgetTheme']);
/* Canned */ 
Route::get('/canned-message', ['as' => '/canned-message', 'uses' => 'Chat\HomeController@getCannedMessage']);
Route::get('/canned-message/add', ['as' => '/canned-message/add', 'uses' => 'Chat\HomeController@getCannedMessageAdd']);
Route::post('/canned-message/add', ['as' => '/canned-message/add', 'uses' => 'Chat\CannedController@doAdd']);
Route::get('/canned-message/edit/{id}', ['as' => '/canned-message/edit/{id}', 'uses' => 'Chat\HomeController@getCannedMessageEdit']);
Route::post('/canned-message/edit', ['as' => '/canned-message/edit', 'uses' => 'Chat\CannedController@doEdit']);
Route::get('/canned-message/delete', ['as' => '/canned-message/delete', 'uses' => 'Chat\CannedController@doDelete']);
/* End Canned */ 
Route::get('/message-history', ['as' => '/message-history', 'uses' => 'Chat\HomeController@getMessageHistory']);
Route::get('/message-history/list', ['as' => '/message-history/list', 'uses' => 'Chat\HomeController@getMessageHistoryList']);
Route::get('/logs', ['as' => '/logs', 'uses' => 'Chat\HomeController@getLogs']);

Route::get('/login', ['as' => '/login', 'uses' => 'Chat\UserController@getLogin']);
Route::post('/login', ['as' => '/login', 'uses' => 'Chat\UserController@doLogin']);
Route::get('/logout', ['as' => '/logout', 'uses' => 'Chat\UserController@doLogout']);
/* Chat */ 
Route::get('/chat', ['as' => '/chat', 'uses' => 'Chat\HomeController@getChat']);
Route::post('/update/name', ['as' => '/update/name', 'uses' => 'Chat\ClientController@updateName']);
Route::post('/update/email', ['as' => '/update/email', 'uses' => 'Chat\ClientController@updateEmail']);
Route::post('/update/phone', ['as' => '/update/phone', 'uses' => 'Chat\ClientController@updatePhone']);
Route::post('/insert/id', ['as' => '/insert/id', 'uses' => 'Chat\ClientController@getClientDetails']);
Route::post('/update/id', ['as' => '/update/id', 'uses' => 'Chat\ClientController@getClientDetailsUpdate']);
Route::get('/agent/update', ['as' => '/agent/update', 'uses' => 'Chat\ClientController@updateAgent']);
Route::post('/online/update', ['as' => '/online/update', 'uses' => 'Chat\ClientController@getPoOnline']);
Route::post('/online/agent/update', ['as' => '/online/agent/update', 'uses' => 'Chat\ClientController@getAgentOnline']);
Route::get('/delete/ip', ['as' => '/delete/ip', 'uses' => 'Chat\ClientController@deleteIP']);
Route::post('/chat/contact', ['as' => '/chat/contact', 'uses' => 'Chat\ClientController@getChatContact']);
Route::post('/chat/refreshMessage', ['as' => '/chat/refreshMessage', 'uses' => 'Chat\MessageController@getChat']);
Route::post('/chat/sendMessage', ['as' => '/chat/sendMessage', 'uses' => 'Chat\MessageController@sendMessage']);
Route::post('/joined/conversation', ['as' => '/joined/conversation', 'uses' => 'Chat\MessageController@getJoin']);
Route::post('/chat/sendMessages', ['as' => '/chat/sendMessages', 'uses' => 'Chat\MessageController@sendMessages']);
Route::post('/chat/view/deactive', ['as' => '/chat/view/deactive', 'uses' => 'Chat\MessageController@chatDeactive']);
Route::post('/chat/refreshMessages', ['as' => '/chat/refreshMessages', 'uses' => 'Chat\MessageController@getChats']);
Route::get('/chat/end', ['as' => '/chat/end', 'uses' => 'Chat\MessageController@chatEnd']);
Route::get('/chat/ends', ['as' => '/chat/ends', 'uses' => 'Chat\MessageController@chatEnds']);
Route::post('/chat/check/conversation', ['as' => '/chat/check/conversation', 'uses' => 'Chat\MessageController@getCheckConversation']);
/* End Chat */ 
